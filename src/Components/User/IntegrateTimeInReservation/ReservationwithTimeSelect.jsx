...
import TimsForReservation from './TimsForReservation'; // Assuming Tims is in the same directory

const ReservationwithTimeSelect = () => {
  ...
  const handleTimeRangeSelect = (selectedRange) => {
    if (selectedRange) {
      setReservationData((prevData) => ({
        ...prevData,
        hourStart: selectedRange.hourStart,
        hourEnd: selectedRange.hourEnd,
      }));
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      {/* Time Selection using the Tims component */}
      <TimsForReservation onTimeRangeSelect={handleTimeRangeSelect} />
...
export default ReservationwithTimeSelect;
